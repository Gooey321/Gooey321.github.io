document.addEventListener("DOMContentLoaded", function () {
  ...
  function handleCollision(objA, objB) {
    ...
    if (overlapX < overlapY) {
      ...
      if (!objA.isStatic && !objB.isStatic) {
        ...
        objA.vy =
          (bounciness *
            (objA.vy * (objA.mass - objB.mass) + 2 * objB.mass * objB.vy)) /
          (objA.mass + objB.mass);
        objB.vy =
          (bounciness *
            (objB.vy * (objB.mass - objA.mass) + 2 * objA.mass * tempVy)) /
          (objA.mass + objB.mass);
      } else if (objA.isStatic && !objB.isStatic) {
  ...
  physicalObjects.push(
    new PhysicalObject(125, height - 100, 20, 20, 1, false, rainbowColors[0])
  );
  physicalObjects.push(
    new PhysicalObject(150, height - 100, 20, 20, 1, false, rainbowColors[1])
  );
  physicalObjects.push(
    new PhysicalObject(175, height - 100, 20, 20, 1, false, rainbowColors[2])
  );
  physicalObjects.push(
    new PhysicalObject(125, height - 200, 20, 20, 1, false, rainbowColors[3])
  );
  physicalObjects.push(
    new PhysicalObject(150, height - 200, 20, 20, 1, false, rainbowColors[4])
  );
  physicalObjects.push(
    new PhysicalObject(175, height - 200, 20, 20, 1, false, rainbowColors[5])
  );
  physicalObjects.push(
    new PhysicalObject(125, height - 300, 20, 20, 1, false, rainbowColors[6])
  );
  physicalObjects.push(
    new PhysicalObject(150, height - 300, 20, 20, 1, false, rainbowColors[0])
  );
  physicalObjects.push(
    new PhysicalObject(175, height - 300, 20, 20, 1, false, rainbowColors[1])
  );

  // Stack of rectangles on the right (with colors)
  physicalObjects.push(
    new PhysicalObject(700, height - 150, 20, 20, 1, false, rainbowColors[2])
  );
  physicalObjects.push(
    new PhysicalObject(1200, height - 150, 100, 50, 5, false, rainbowColors[3])
  );
  physicalObjects.push(
    new PhysicalObject(1205, height - 200, 90, 50, 5, false, rainbowColors[4])
  );
  physicalObjects.push(
    new PhysicalObject(1210, height - 250, 80, 50, 4.5, false, rainbowColors[5])
  );
  physicalObjects.push(
    new PhysicalObject(1215, height - 300, 70, 50, 4, false, rainbowColors[6])
  );
  physicalObjects.push(
    new PhysicalObject(1220, height - 350, 60, 50, 3.5, false, rainbowColors[0])
  );
  physicalObjects.push(
    new PhysicalObject(1225, height - 400, 50, 50, 3.5, false, rainbowColors[1])
  );
  physicalObjects.push(
    new PhysicalObject(1230, height - 450, 40, 50, 3.5, false, rainbowColors[2])
  );
  physicalObjects.push(
    new PhysicalObject(1235, height - 500, 30, 50, 3.5, false, rainbowColors[3])
  );
  physicalObjects.push(
    new PhysicalObject(1240, height - 550, 20, 50, 3.5, false, rainbowColors[4])
  );
  physicalObjects.push(
    new PhysicalObject(1245, height - 600, 10, 50, 3.5, false, rainbowColors[5])
  );

  // Platforms (static objects remain black)
  physicalObjects.push(
    new PhysicalObject(0, height - 20, width, 20, 1000, true)
  );
  physicalObjects.push(
    new PhysicalObject(0, height - 500, 200, 20, 1000, true)
  );
  physicalObjects.push(
    new PhysicalObject(500, height - 500, 200, 20, 1000, true)
  );
  physicalObjects.push(
    new PhysicalObject(1000, height - 500, 200, 20, 1000, true)
  );
});
